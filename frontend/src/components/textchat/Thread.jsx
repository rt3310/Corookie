...
const Thread = () => {
    ...
    return (
        <S.Wrap>
            ...
            <S.Imoticons>
                <components.Imoticon icon={utils.IMOTICON_OPTIONS.thumb} count={'990'} />
                <components.Imoticon icon={utils.IMOTICON_OPTIONS.happy} count={'2'} />
                <components.Imoticon icon={utils.IMOTICON_OPTIONS.sad} count={'1'} />
            </S.Imoticons>
        </S.Wrap>
    )
}
