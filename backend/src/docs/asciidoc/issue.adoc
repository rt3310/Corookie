...
include::{snippets}/issue-list-filter-manager/http-request.adoc[]

include::{snippets}/issue-list-filter-manager/path-parameters.adoc[]

include::{snippets}/issue-list-filter-manager/query-parameters.adoc[]

=== Response

include::{snippets}/issue-list-filter-manager/http-response.adoc[]

include::{snippets}/issue-list-filter-manager/response-fields.adoc[]
