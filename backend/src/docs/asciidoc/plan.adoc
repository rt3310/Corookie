...
include::{snippets}/planCategory-create/http-request.adoc[]

include::{snippets}/planCategory-create/path-parameters.adoc[]

include::{snippets}/planCategory-create/request-fields.adoc[]

=== Response

include::{snippets}/planCategory-create/http-response.adoc[]

include::{snippets}/planCategory-create/response-fields.adoc[]
...
include::{snippets}/planCategory-delete/http-request.adoc[]

include::{snippets}/planCategory-delete/path-parameters.adoc[]

include::{snippets}/planCategory-delete/request-fields.adoc[]

=== Response

include::{snippets}/planCategory-delete/http-response.adoc[]
